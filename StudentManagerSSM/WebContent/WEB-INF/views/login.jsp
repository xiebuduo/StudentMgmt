...
<link href="../h-ui/lib/icheck/icheck.css" rel="stylesheet"
	type="text/css" />
<link href="../h-ui/lib/Hui-iconfont/1.0.1/iconfont.css"
...
<script type="text/javascript">
	$(function() {
		...
		$("#vcodeImg").click(
				function() {
					this.src = "get_cpacha?count=1&w=110&h=40&t="
							+ new Date().getTime();
				});
...
<body>
	...
	<div class="header" style="padding: 0;">
		<h2
			style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">学生信息管理系统</h2>
	</div>
			...
			<form id="form" class="form form-horizontal" method="post">
				<div class="row cl">
					...
					<div class="formControls col-8">
						<input id="stuno" name="userid" type="text" placeholder="账号" value=""
				...
				<div class="row cl">
					<div class="formControls col-8 col-offset-3">
						<input class="input-text size-L" name="vcode" type="text"
							...
							src="get_cpacha?count=4&w=110&h=40">
					</div>
				</div>

				<div class="mt-20 skin-minimal" style="text-align: center;">
					<div class="radio-box">
						<input type="radio" id="radio-1" name="typed" checked value="1" /> <label
							for="radio-3">管理员</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="radio-2" name="typed" value="2" />
	...
	<div class="footer">Copyright &nbsp; @xiebuduo</div>
